...
for split in ['train', 'test', 'festival', 'voting']:
    name = 'dit_{}'.format(split)
    devkit_path = 'data/DIT/'
    root_path = 'data'
    __sets[name] =  (lambda split=split : DIT(split, 'data', 'data/DIT', 'data/DIT'))
